...
- [CLI / Developer experience](https://github.com/hyperledger-firefly/firefly-cli)
- [FireFly Samples](https://github.com/hyperledger-firefly/firefly-samples)
- [UI Explorer](https://github.com/hyperledger-firefly/firefly-ui)
- [Core](https://github.com/hyperledger-firefly/firefly)
- [HTTP Data Exchange](https://github.com/hyperledger-firefly/firefly-dataexchange-https)
- [Ethereum (Hyperledger Besu / Quorum) connector](https://github.com/hyperledger-firefly/firefly-ethconnect)
- [Corda connector](https://github.com/hyperledger-firefly/firefly-cordaconnect)
- [Hyperledger Fabric connector](https://github.com/hyperledger-firefly/firefly-fabconnect)
- [Token connector reference implementation (ERC1155)](https://github.com/hyperledger-firefly/firefly-tokens-erc1155)
