...
You can utilize the [ffconfig](https://github.com/hyperledger-firefly/firefly/tree/main/ffconfig) tool to automatically check and fix deprecated config with a command such as:
