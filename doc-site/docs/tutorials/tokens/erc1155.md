...
See the [README](https://github.com/hyperledger-firefly/firefly-tokens-erc1155/blob/main/README.md) of the token connector for details on what contract variants can currently be understood.
